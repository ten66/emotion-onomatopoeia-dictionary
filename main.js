...
class EmotionObject{
  ...
  getOnomatopoeiaWords(){
      ...
      for(let i = 0; i < this.onomatopoeia.length; i++){
          ...
          words.push(new Word(word, dictionary[word], pictureDictionary[word]));
      }
  ...
  getHtmlContainerString(){
      ...
      `
          <div id="${this.emotion}" class="d-flex justify-content-center" style="background: ${bgColors[this.color]};">
      ...
      for(let i = 0; i < this.getOnomatopoeiaWords().length; i++){
          let card = this.getOnomatopoeiaWords()[i];
          onomatopoeiaContainer +=
          `
              <div class="d-flex align-items-center bg-white col-12 col-md-5 m-2">
                  <div class="col-6">
                      <h5>${card.word}</h5>
                      <p>${card.defintion}</p>
                  </div>
                  <div class="col-6 pt-2">
                      <img src="${card.pictureUrl}" class="box">
                  </div>
              </div>
          `;
      }
...
const emotionImages = {
  ...
  "happy": "https://cdn.pixabay.com/photo/2017/12/11/15/34/lion-3012515__340.jpg",
  "bad": "https://cdn.pixabay.com/photo/2018/02/21/15/06/woman-3170568__340.jpg",
  "sad": "https://cdn.pixabay.com/photo/2017/08/10/03/47/guy-2617866__340.jpg",
  "surprised": "https://cdn.pixabay.com/photo/2016/11/02/00/37/bouquet-1790142__340.jpg",
  "fearful": "https://cdn.pixabay.com/photo/2016/09/01/01/43/little-boy-1635065__340.jpg",
  "disgusted": "https://cdn.pixabay.com/photo/2012/02/23/08/48/disgust-15793__480.jpg"
}
...
for(let i = 0; i < emotions.length; i++){
  ...
  tableOfContents += 
  `
          <div class="col-5 col-md-3 text-center m-2" style="background: ${bgColors[currEmotion.color]};">
              <h4><a href="#${currEmotion.emotion}">${currEmotion.emotion}</a></h4>
...
document.getElementById("target").innerHTML = tableOfContents;
